...
macro(test_targets)
  ...
  elseif(NOT APPLE) # Supported archs for Apple platforms are generated later
    ...
    elseif("${COMPILER_RT_DEFAULT_TARGET_ARCH}" MATCHES "dc32le")
      test_target_arch(dc32le "" "")
    elseif("${COMPILER_RT_DEFAULT_TARGET_ARCH}" MATCHES "dc64le")
      test_target_arch(dc64le "" "")
    elseif("${COMPILER_RT_DEFAULT_TARGET_ARCH}" MATCHES "dc32be")
      test_target_arch(dc32be "" "")
    elseif("${COMPILER_RT_DEFAULT_TARGET_ARCH}" MATCHES "dc64be")
      test_target_arch(dc64be "" "")
    endif()
